...
/**
 * @author: yyh
 * @date: 2021-12-01 10:28
 * @description: DigestServerAuthenticationHelper
 **/
public class DigestServerAuthenticationHelper  {

    private final Logger logger = LoggerFactory.getLogger(DigestServerAuthenticationHelper.class);
    ...
    public static String toHexString(byte b[]) {
        ...
        for (byte value : b) {
            c[pos++] = TO_HEX[(value >> 4) & 0x0F];
            c[pos++] = TO_HEX[value & 0x0f];
        }
        return new String(c);
    }
